...
def _pb2() -> Any:
    from infrastructure.oauth.google.grpc import oauth_google_pb2

    return oauth_google_pb2
...
class GoogleOAuthService(generics.GenericService):
    """Begin and finish a google sign-in."""
...
GRPC_SERVICES = [GoogleOAuthService]
