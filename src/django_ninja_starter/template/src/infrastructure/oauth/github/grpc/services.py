...
from infrastructure.oauth.github.provider import provider


def _pb2() -> Any:
    from infrastructure.oauth.github.grpc import oauth_github_pb2

    return oauth_github_pb2
...
class GitHubOAuthService(generics.GenericService):
    """Begin and finish a github sign-in."""
...
GRPC_SERVICES = [GitHubOAuthService]
