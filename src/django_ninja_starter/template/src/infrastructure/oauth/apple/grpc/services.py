...
def _pb2() -> Any:
    from infrastructure.oauth.apple.grpc import oauth_apple_pb2

    return oauth_apple_pb2
...
class AppleOAuthService(generics.GenericService):
    """Begin and finish a apple sign-in."""
...
GRPC_SERVICES = [AppleOAuthService]
